...
with webdriver.Chrome() as browser:
    ...
    try:
        ...
        browser.find_element(By.XPATH, "//div[@data-control-name='BTL_Employees']//input").send_keys("Тестовый")
        browser.find_element(By.XPATH, "//a[@title = 'Тестовый пользователь']").click()
